...
class VasosWeekCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rec = data.weeklyVasos[mondayIso] ?? const WeeklyVasosEntity();
    final name = rec.personId != null ? data.nameOf(rec.personId) : null;
