...
class StatsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasHistory = stats.totalGaseosaDays + stats.totalVasosWeeks > 0;
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${stats.gaseosaOf(p.id)} días de '
                                      'gaseosa · ${stats.vasosOf(p.id)} '
                                      'semanas de vasos',
                                      style: textTheme.bodySmall?.copyWith(
                                        color: AppTheme.onSurfaceVariant,
                                      ),
                              ...
                              Text(
                                formatCop(stats.gastoCopOf(p.id)),
                                style: textTheme.titleSmall?.copyWith(
