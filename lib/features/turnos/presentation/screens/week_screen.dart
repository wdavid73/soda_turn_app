...
import '../widgets/vasos_edit_sheet.dart';
import '../widgets/vasos_week_card.dart';
...
class WeekScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final vasosId = ui.data.weeklyVasos[mondayIso]?.personId;
        ...
        child: ListView(
          ...
          children: [
            ...
            VasosWeekCard(
              data: ui.data,
              mondayIso: mondayIso,
              onTap: () => showVasosEditSheet(context),
              onToggleLock: vm.toggleVasosLock,
            ),
            const SizedBox(height: 12),
            for (final dayIso in AppDateUtils.weekDays(mondayIso)) ...[
              DayCard(
                ...
                onToggleLock: () => vm.toggleDayLock(dayIso),
              ),
              const SizedBox(height: 12),
            ],
          ],
